...
prog = "FDLog v4-1-152j (modified by KC7SDA 5-15-2017) 2014/05/26 distributed under the GNU Public License\n"\
...
Please read version_history.txt for a complete list of the version history
